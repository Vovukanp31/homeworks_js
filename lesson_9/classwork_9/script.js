...
for (const coursesArrayElement of coursesArray) {
    ...
    title.innerText = `Назва курсу: ${coursesArrayElement.title}`;
    let duration = document.createElement('div');
    let monthDuration = document.createElement('div');
    monthDuration.className = 'monthDuration';
    monthDuration.innerText = `Тривалість курсу( місяці): ${coursesArrayElement.monthDuration}`;
    let hourDuration = document.createElement('div');
    hourDuration.className = 'hourDuration';
    hourDuration.innerText = `Тривалість курсу( години): ${coursesArrayElement.hourDuration}`;
    let modulesList = document.createElement('ul');
    for (const modulesElement of coursesArrayElement.modules) {
                let listElement = document.createElement('li');
                listElement.innerText = modulesElement;
                modulesList.append(listElement);
    }
    container.append(title);
    duration.append(monthDuration);
    duration.append(hourDuration)
    container.append(duration);
    container.append(modulesList);
