            ...
            for (const objElement in obj) {
                if (typeof obj[objElement] === 'object') {
                    ...
                    divOfValues.innerText = `${objElement} - ${obj[objElement]}`;
                     div.append(divOfValues);
                     divOfValues.style.border = '1px solid brown';
                     divOfValues.style.marginBottom = '4px';
                     divOfValues.style.padding = '2px';
                }
            }
        };
        let div = document.createElement('div');
        arrElemCreator(arrElement);
